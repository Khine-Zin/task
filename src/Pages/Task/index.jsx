...
console.log(datacontent)
  ...
  <Select
    ...
    label="Select Brand"
      sx={{
    '& .MuiSelect-select': {
      padding: '14px 10px', // your custom padding here
    },
  }}
  >
    {brand.length === 0 ? (
  ...
  {datacontent?.length === 0 || dataHeadline === undefined ? (
   ...
   <div className="flex gap-5 justify-end items-center mt-4">
        ...
        <div className="flex gap-2">
          ...
          <button disabled={pager.currentPage === total?.totalPages?.headline && total?.totalPages?.content} onClick={() => handlePageChange(1)} className="p-2 bg-gray-200 rounded-r hover:bg-gray-300">
            <HiChevronRight />
          </button>
        </div>
      </div>
